public static class Constants {
    ...
    // Wait times for restart and start. seconds until starting up the game
    public const float WAIT_STARTGAME = 0.0f;
    public const float WAIT_RESUMEGAME = 1.0f;
    public const float WAIT_AFTERREWARDEDAD = 1.5f;

    public const int INITIAL_SPAWN_DIST = 30;
    public const int LETTER_SPAWN_DIST = 10;
    ...
    public const float MAX_PLAYER_SPEED = 2500f;
    public const float DIRECTIONAL_SPEED = 30f;
    public const float SPEED_INCREMENT = 0.1f;

    public const float SIDE_MAX_MOVE = 2.5f;
    ...
    public const string cc0link = "cc0";
    public const string popcornIssuesLink = "PopcornIssuesLink";
}
